            ...
            <div style={{ transform: 'scale(2, 2) translate(-25px, 20px)' }}>
                ...
                <select name="toppings" id="toppings" onChange={(e) => {
                    ...
                    if (selectedOption === 'mantarlı') {
                        document.getElementById('toppingsImage').src = food3;
                    } else if (selectedOption === 'mısırlı') {
                        document.getElementById('toppingsImage').src = food3;
                    }
                }}>
                    <option value="mantarlı">Sade</option>
                    <option value="mısırlı">Acılı</option>
                </select>
                <img id="toppingsImage" src={food3} alt="Mantarlı" style={{ width: '80px', transform: 'translate(30px, 20px)' }}/>
            </div>
